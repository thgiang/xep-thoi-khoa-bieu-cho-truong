...
class GenData extends Command
{
    ...
    public function handle()
    {
        ...
        $data[] = ['name' => 'Tuấn', 'line' => 'Văn 7 D 4'];
        $data[] = ['name' => 'Tân', 'line' => 'Văn 9 BD 10'];
        $data[] = ['name' => 'Tr.Hoa', 'line' => 'Văn 7 AB 8,CD 8 ABCD 4'];
        $data[] = ['name' => 'Thơm', 'line' => 'Văn 7 C 4,Sử 8 ABCD 8,CN 6 AB 4,CN 7 ABCD 4'];
        $data[] = ['name' => 'Hường', 'line' => 'Văn 8 AC 8,TD 7 AB 4'];
        $data[] = ['name' => 'L.Anh', 'line' => 'Văn 8 BD 8,CD 9 ABCD 4'];
        $data[] = ['name' => 'Nguyệt', 'line' => 'Văn 9 AC 10,Địa 8 AC 2'];
        $data[] = ['name' => 'Tr.Xuyến', 'line' => 'Sử 9 ABCD 4,CD 7 ABCD 4'];
        ...
        $data[] = ['name' => 'Bông', 'line' => 'Văn 6 AB 8,CD 6 ABCD 4'];
