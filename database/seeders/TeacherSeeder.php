...
class TeacherSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data[] = ['name' => 'Hà HT', 'team_id' => null, 'has_children' => false];
        $data[] = ['name' => 'Nhung', 'team_id' => 8, 'has_children' => false];
        $data[] = ['name' => 'Tâm', 'team_id' => 5, 'has_children' => false];
        $data[] = ['name' => 'Hà Tin', 'team_id' => 9, 'has_children' => false];
        $data[] = ['name' => 'Hồ Tuấn', 'team_id' => null, 'has_children' => false];
        $data[] = ['name' => 'Tân', 'team_id' => 16, 'has_children' => false];
        $data[] = ['name' => 'Tr.Hoa', 'team_id' => 6, 'has_children' => false];
        $data[] = ['name' => 'Thơm', 'team_id' => null, 'has_children' => false];
        $data[] = ['name' => 'Hường', 'team_id' => 11, 'has_children' => false];
        $data[] = ['name' => 'Lan Anh', 'team_id' => 12, 'has_children' => false];
        $data[] = ['name' => 'Nguyệt', 'team_id' => 15, 'has_children' => false];
        $data[] = ['name' => 'Tr.Xuyến', 'team_id' => 3, 'has_children' => false];
